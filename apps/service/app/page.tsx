...
const Home = async () => {
  ...
  return (
    <main className="w-full h-full mx-auto max-w-7xl">
      <section className="grid grid-cols-1 px-10 mt-8 md:grid-cols-2 md:mt-24 ">
        <div className="mb-12 md:mb-0 lg:mt-24">
          <h1 className="mt-10 text-5xl font-bold sm:mt-0 sm:text-6xl">
            나를 소개하는
            <br /> 링크를 연결해보세요!
          </h1>
          <p className="mt-2">프로필 페이지에서 나를 소개하는 링크를 생성하면 그래프 형태로 보여집니다.</p>
          <button
            type="button"
        ...
        <div className="flex items-center justify-center w-full">
          <Image src="/linkgraph.png" width={500} height={400} alt="linkgraph" />
        </div>
      </section>
